...
<head>
    ...
    <link href="css/aprobaciones.css" rel="stylesheet" type="text/css">
    <link href="css/aprobaciones.css" rel="stylesheet" type="text/css">
                                ...
                                <tbody>
                                    ...
                                    while ($rowSql = $sql->fetch_assoc()) {   ?>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center;"><?php echo $rowSql["semestre_cursado"]; ?></td>
                                            <td style="text-align: center;"><?php echo $rowSql["especialidad"]; ?></td>
